 ...
 * I have modified getValue to do i18n translations.
 * jon pallas
 * 
 * this is intended as a sample of the way you can do i18n not a complete solution
 * 
 */
...
import org.atgel.i18n.TranslationTools;
import org.atgel.userprofiling.UserTools;
 ...
 */
public class I18nELResolver extends ELResolver {
	 ...
	 * given parameter.
	 */
	public I18nELResolver(boolean readOnly) {
	...
	public Object getValue(ELContext context, Object base, Object property) {
		...
		Object result = null;
		if (isResolvable(property) && (property != null && property.equals("i18n"))) {
			result = "i18n";
			context.setPropertyResolved(true);
			return result;
		}
		if (isResolvable(base)) {
			...
			result = TranslationTools.translate(property.toString(), locale);
			context.setPropertyResolved(true);
		}
	...
	public void setValue(ELContext context, Object base, Object property, Object value) {
		throw new RuntimeException("i18n cant be set just read");
	}
	...
	private final boolean isResolvable(Object base) {
		...
		return base.toString().equals("i18n");
	}
}
